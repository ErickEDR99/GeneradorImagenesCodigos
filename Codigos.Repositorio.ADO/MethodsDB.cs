...
namespace Codigos.Repositorio.ADO
{
    public class MethodsDB
    {
        ...
        public const string QueryObtenerBandejaPaginado = @"[Notificaciones].[uspObtenerBandejaPaginado]";
        ...
        public string[] QueryObtenerValidacionNotificacionArreglo = [
            "[Notificaciones].[uspValidacionCustodiosAsignados]",
            "[Notificaciones].[uspValidacionInfraccionesRegistradas]",
            "[Notificaciones].[uspValidacionDiasInactividad]",
            "[Notificaciones].[uspValidacionAsignacionesManifiestos]",
            "[Notificaciones].[uspValidacionAsignacionesResguardos]",
            "[Notificaciones].[uspValidacionComprobacionesGastosPendientes]",
            "[Notificaciones].[uspValidacionManifiestosAbiertos]",
            "[Notificaciones].[uspValidacionDocumentosVencerColaboradores]",
            "[Notificaciones].[uspValidacionDocumentosVencidosColaboradores]",
            "[Notificaciones].[uspValidacionChecklistVencerColaboradores]",
            "[Notificaciones].[uspValidacionChecklistVencidosColaboradores]",
            "[Notificaciones].[uspValidacionManifiestosAbiertosExcedidos]",
            "[Notificaciones].[uspValidacionGastosNoComprobadosExcedidos]",
            "[Notificaciones].[uspValidacionMovimientosGastosOperativos]",
            ...
            "[Notificaciones].[uspValidacionMovimientosConRestriccionesHorarios]",
            "[Notificaciones].[uspValidacionRetrasosInicioViajeContraTiempoPromesas]",
            "[Notificaciones].[uspValidacionRetrasosFinViajeContraTiempoPromesas]",
            "[Notificaciones].[uspValidacionParadasPuntosNoAutorizados]",
            "[Notificaciones].[uspValidacionVehiculosAutorizadosNoPosicionan]",
            "[Notificaciones].[uspValidacionGeolocalizaciones]",
            "[Notificaciones].[uspValidacionAperturasPuertasFueraDestino]",
            "[Notificaciones].[uspValidacionMovimientosVehiculosSinManifiestos]",
            "[Notificaciones].[uspValidacionVehiculosSinPosicionamientos]",
            "[Notificaciones].[uspValidacionServiciosRetrasados]",
            "[Notificaciones].[uspValidacionSeguroSocialRequeridos]",
            "[Notificaciones].[uspValidacionServiciosOperadosTerceros]",
            "[Notificaciones].[uspValidacionTicketsRecibidosSinCostos]",
            "[Notificaciones].[uspValidacionCancelacionesTickets]",
            "[Notificaciones].[uspValidacionManifiestosCreadosForaneos]",
            "[Notificaciones].[uspValidacionManifiestosAbiertosPorHoras]",
            "[Notificaciones].[uspValidacionRegistrosTardiosCustodias]",
            "[Notificaciones].[uspValidacionRetrasoTiemposPromesasCargas]",
            "[Notificaciones].[uspValidacionAsignacionesColaboradoresNoPermitidos]",
            "[Notificaciones].[uspValidacionAsignacionesVehiculosNoPermitidos]",
            "[Notificaciones].[uspValidacionTicketsNoEntregados]",
            "[Notificaciones].[uspValidacionDocumentosVencerRemolques]",
            "[Notificaciones].[uspValidacionDocumentosVencidosRemolques]",
            "[Notificaciones].[uspValidacionChecklistVencidosRemolques]",
            "[Notificaciones].[uspValidacionChecklistVencerRemolques]",
            "[Notificaciones].[uspValidacionDocumentosVencerVehiculos]",
            "[Notificaciones].[uspValidacionChecklistVencidosVehiculos]",
            "[Notificaciones].[uspValidacionChecklistVencerVehiculos]",
            "[Notificaciones].[uspValidacionDocumentosVencidosVehiculos]",
        ];
        #endregion
        #region Validaciones para Códigos QR BARCODE
        public const string QueryValidarRegistrosNuevos = @"[Componentes].[uspValidarRegistrosNuevos]";
        public const string QueryInsertarActualizarImagenesCodigos = @"[Componentes].[uspInsertarActualizarImagenesCodigos]";
        #endregion
    }
}
