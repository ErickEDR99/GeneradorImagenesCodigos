...
namespace Codigos.Repositorio.ADO.Common
{
    public class DataAccessor : IAccessor
    {
        ...
        Respuesta IAccessor.SpExcuteJson(string storedProcedureName, IEnumerable<SqlParameter>? parameters)
        {
            throw new NotImplementedException();
        }

        Respuesta IAccessor.SpSaveJson(out long Id, string storedProcedureName, IEnumerable<SqlParameter>? parameters)
        {
            throw new NotImplementedException();
        }

        Respuesta IAccessor.ExecuteSp<T>(string storedProcedureName, IEnumerable<SqlParameter>? parameters)
        {
            throw new NotImplementedException();
        }

        public Respuesta SpExcuteValidacion(out List<ImagenCodigo> ObjectArray, string storedProcedureName, IEnumerable<SqlParameter>? parameters = null)
        {
            throw new NotImplementedException();
        }
    }
